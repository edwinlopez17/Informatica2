...
public class BinaryTree : IBinTree{             ///////////////////////Herencia de IBinTree
    public int Valor {get;}                       ///Valor en modo de lectura

    public IBinTree Derecho { get; set; }           ///Modo de lectura y ecritura

    public IBinTree Izquierdo { get; set; }

    public BinaryTree(int valor, IBinTree derecho, IBinTree izquierdo){            ////Constructor
        this.Valor = valor;
